...
class ClaimStoryAgentTests(unittest.TestCase):
    def test_factory_configures_structured_single_turn_agent(self) -> None:
        agent = create_claim_story_agent(test_settings(), EmptyRepository())
        ...
        self.assertEqual("single_turn", agent.mode)
